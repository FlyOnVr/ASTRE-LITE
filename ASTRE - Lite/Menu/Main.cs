...
namespace StupidTemplate.Menu
{
                    ...
                    transform =
    {
        parent = canvasObject.transform
                ...
                CoroutineHandler.Instance.StartCoroutine(new Main().AnimateColorTransition(text));
    ...
    ButtonCornerD
        ...
        public static void CreateOtuline(float offset, ButtonInfo method)
        {
            if (ens)
            {
                ...
                BaseA2.GetComponent<Renderer>().material.color = OutlineColor;
                ...
                BaseB2.GetComponent<Renderer>().material.color = OutlineColor;
                ...
                RoundCornerA2.GetComponent<Renderer>().material.color = OutlineColor;
                ...
                RoundCornerB2.GetComponent<Renderer>().material.color = OutlineColor;
                ...
                RoundCornerC2.GetComponent<Renderer>().material.color = OutlineColor;
                ...
                RoundCornerD2.GetComponent<Renderer>().material.color = OutlineColor;
        ...
        public static Texture2D LoadTextureFromResource(string resourceName)
        {
            ...
            Texture2D texture2D;
            using (Stream manifestResourceStream = executingAssembly.GetManifestResourceStream("AetherTemplate.Arrows." + resourceName))
            {
        ...
        public static Color OutlineColor = new Color(0.054f, 0.054f, 0.054f);
