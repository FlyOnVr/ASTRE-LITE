        ...
        public static List<(Color color, string name)> colorCycle = new List<(Color, string)>
{
    ...
    (new Color(176f / 255f, 153f / 255f, 128f / 255f), "maincolor")
        ...
        public static void GunTemplate()
        {
            ...
            {
                if (Physics.Raycast(GorillaTagger.Instance.rightHandTransform.position, -GorillaTagger.Instance.rightHandTransform.up, out var hitinfo))
                {
                    ...
                    if (GunSphere == null)
                    {
                        ...
                        {
                            linePositions[i] = GorillaTagger.Instance.rightHandTransform.position;
                        }
                    }
